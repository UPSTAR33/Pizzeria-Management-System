...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2021 at 10:41 AM
...
INSERT INTO `customer` (`cust_id`, `name`, `phoneno`, `email_id`, `pwd`) VALUES
(6, 'rachael green', '69', 'r@g.com', '69'),
(10, 'Yash Brahmkshatriya', '1234567890', 'y@b.com', 'yash'),
(12, 'Ross Geller', '9876543210', 'ross@geller.com', '69'),
(29, 'Harshad Mehta', '50', 'h@m.com', '12'),
(50, 'Elon Musk', '9998887776', 'elon@musk.com', 'spacex'),
(51, 'Sadie Sink', '7412589630', 'sadie@sink.com', '123456'),
(52, 'Demogorgon', '9638574210', 'demogorgon@st.com', '123456');
...
--
ALTER TABLE `customer`
  MODIFY `cust_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'customer id', AUTO_INCREMENT=53;
